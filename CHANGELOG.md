...
- The citation examples and `CITATION.cff` now give the 0.2.2 version DOI
  ([10.5281/zenodo.22813001](https://doi.org/10.5281/zenodo.22813001)). The all-versions DOI is
  unchanged.
